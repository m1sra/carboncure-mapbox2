const Story = () =>{
  return (
    <div className="story-1">
      ...
      <ul>
        <li>
        CarbonCure is a carbon removal technology company that is decarbonizing the global concrete industry.
        </li>
        <li>
        CarbonCure designs and deploys technologies that inject captured CO2 into the concrete-making process, where it is mineralized and permanently stored.
        </li>
        <li>
